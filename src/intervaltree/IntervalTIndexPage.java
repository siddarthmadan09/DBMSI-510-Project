...
public class IntervalTIndexPage extends IntervalTSortedPage{
   ...
   */
  public IntervalTIndexPage(PageId pageno, int keyType) 
    throws IOException, 
   ...
   *@exception ConstructPageException error when BTIndexpage constructor
   */
  public IntervalTIndexPage(Page page, int keyType) 
    throws IOException, 
	   ConstructPageException
    {
      super(page, keyType);
   ...
   *@exception ConstructPageException error when BTIndexpage constructor
   */
  public IntervalTIndexPage( int keyType) 
    throws IOException, 
	   ConstructPageException
    {
      super(keyType);
   ...
   */
  boolean redistribute(IntervalTIndexPage indexPage, IntervalTIndexPage parentIndexPage,
